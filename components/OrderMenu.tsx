...
interface IOrderMenuProps extends ViewProps {
  orderMenu: boolean
  setOrderMenu: any
}
  ...
  return (
    ...
    >
      <View className='flex-2 flex-row justify-between'>
        ...
        <TouchableOpacity onPress={() => setOrderMenu(true)}>
      ...
      <View className='flex-2 flex-row items-center justify-between'>
        ...
        <TouchableOpacity className='flex-2 flex-row py-2 px-4 rounded-xl bg-blue-500'>
          ...
          <Ionicons name='swap-vertical-sharp' size={20} color='white' />
        </TouchableOpacity>
      </View>
    </View>
  )
